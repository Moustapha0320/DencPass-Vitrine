...
const prepColors = input => {
  const base = (input && input.length ? input : ['#2fd9f4', '#8b5cf6', '#070e1c']).slice(0, MAX_COLORS);
...
const Lightfall = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`lightfall-container${className ? ` ${className}` : ''}`}
